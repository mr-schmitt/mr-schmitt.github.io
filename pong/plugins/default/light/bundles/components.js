...
var LightUpdater = (function () {
    ...
    LightUpdater.prototype.onLightResourceReceived = function (resourceId, resource) {
        this.lightSettings = resource;
        this.updateLightShadowMap();
    };
    LightUpdater.prototype.onLightResourceEdited = function (resourceId, command, propertyName) {
